...
//    self.dataSource = self;
    ...
    [ChatDemoHelper shareHelper].chatVC = self; // yc环信
...
//    [backButton setImage:[UIImage imageNamed:@"btn_chevron left_n"] forState:UIControlStateNormal];
//    backButton.backgroundColor = [UIColor redColor];
//    [backButton addTarget:self action:@selector(backAction) forControlEvents:UIControlEventTouchUpInside];
//    UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithCustomView:backButton];
//    [self.navigationItem setLeftBarButtonItem:backItem];
    
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"btn_chevron left_n"] style:UIBarButtonItemStylePlain target:self action:@selector(backAction) ];
                           ...
                           modelForMessage:(EMMessage *)message
{
    ...
    model.avatarURLPath = [self.ycDelegate avatarURLForUserID:userID];
    model.nickname = [self.ycDelegate nickNameForUserID:userID];
...
//    if ([[model valueForKey:@"text"] isEqualToString:@""]) {
//        
//    }
    
    if ([model.nickname isEqualToString:@"18362970827"]) {
